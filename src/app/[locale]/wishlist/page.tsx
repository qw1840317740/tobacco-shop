...
export default function WishlistPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6">
      <h1 className="font-heading text-3xl font-bold text-stone-800">お気に入り</h1>
      {loading ? (
        <p className="mt-8 text-center text-stone-400">読み込み中...</p>
      ) : items.length === 0 ? (
        <div className="mt-16 text-center">
          <p className="text-stone-400">お気に入り商品はまだありません。</p>
