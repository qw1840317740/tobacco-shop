...
export default function TermsPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6">
      ...
      <h1 className="font-heading text-3xl font-bold text-stone-800">利用規約</h1>
      ...
      <div className="mt-8 space-y-8 text-sm leading-relaxed text-stone-600">
        <section>
          <h2 className="font-heading text-lg font-semibold text-stone-800">第1条（総則）</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="font-heading text-lg font-semibold text-stone-800">第2条（年齢確認）</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="font-heading text-lg font-semibold text-stone-800">第3条（ご注文について）</h2>
        ...
        <section>
          <h2 className="font-heading text-lg font-semibold text-stone-800">第4条（お支払い）</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="font-heading text-lg font-semibold text-stone-800">第5条（配送）</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="font-heading text-lg font-semibold text-stone-800">第6条（返品・交換）</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="font-heading text-lg font-semibold text-stone-800">第7条（禁止事項）</h2>
        ...
        <section>
          <h2 className="font-heading text-lg font-semibold text-stone-800">第8条（免責事項）</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="font-heading text-lg font-semibold text-stone-800">第9条（規約の変更）</h2>
          <p className="mt-3">
        ...
        <section>
          <h2 className="font-heading text-lg font-semibold text-stone-800">第10条（準拠法・管轄）</h2>
          <p className="mt-3">
