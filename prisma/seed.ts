...
async function main() {
  ...
  // Create products — removed comparePrice and strength (not in schema)
  const products = [
    {
      id: "prod_1", slug: "seven-stars", name: "Seven Stars", price: 520,
      image: "https://upload.wikimedia.org/wikipedia/en/6/69/Sevenstars.jpg",
      type: "CIGARETE", region: "Japan", inStock: true, featured: true,
      desc: "JT人気ブランド。1969年発売の日本を代表するプレミアムたばこ。豊かで深い味わい。",
      categoryId: category.id,
    },
    {
      id: "prod_2", slug: "caster", name: "Caster", price: 480,
    ...
    {
      id: "prod_5", slug: "lark", name: "Lark", price: 530,
    ...
    {
      id: "prod_8", slug: "winston", name: "Winston", price: 490,
      image: "https://images.unsplash.com/photo-1572113564617-7230ee196d9a?w=600&q=80",
      type: "CIGARETE", region: "Japan", inStock: true, featured: false,
      desc: "JTが国内製造・販売する世界的ブランド。バランスの良い味わい。",
      categoryId: category.id,
    },
    {
      id: "prod_9", slug: "camel", name: "Camel", price: 520,
    ...
    {
      id: "prod_10", slug: "natural-american-spirit", name: "Natural American Spirit", price: 780,
  ...
  // Create default admin — uses scrypt with salt (matches admin-store.ts)
  ...
  // Create test customer user — uses scrypt with salt (matches user-store.ts)
  await db.user.upsert({
    where: { email: "test@example.com" },
    update: { passwordHash: hashPassword("test123") },
    create: {
      id: "user_test",
